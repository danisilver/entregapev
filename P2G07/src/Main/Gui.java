...
public class Gui extends JFrame {
	...
	JButton filechooserbutton = new JButton("Select the file");
	...
	public Gui() {
		...
		cbTipoSeleccion.setModel(new DefaultComboBoxModel<String>(new String[] { "Ruleta", "Estocastico", "Torneo","Ranking","Truncamiento" }));
